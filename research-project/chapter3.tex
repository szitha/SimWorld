...
\end{tcolorbox}
 ...
 The Katdal library can manipulate the HDF5 observation file in many ways including file format conversion from HDF5 to measurement sets. This option is useful for astronomers using CASA for data calibration and visualization.
...
\end{figure}
 ...
 \centering
    ...
    \caption{A clean image of the phase calibrator PKS1613-586 located at  RA, Dec (J2000): 16:17:17.88951, -58:48:07.8604. (freq=1.82688e+09 Hz) is: 4.59973 +/- 0.0146351. after calibration process and estimated solutions have been applied to the corrupted data.}
  \label{pks1613}
\end{figure}
