...
The following code is showing how the parameters were set in standard practice of 1GC as described in chapter 1.
...
#G solution for gain cal (BP applied)
default(gaincal)
vis = msfile
caltable = gaintable
