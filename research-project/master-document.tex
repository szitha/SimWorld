...
\author{Simphiwe Nhlanhla Zitha (nhlanhla34@gmail.com)\\
...
% University of Stellenbosch, South Africa
{\small Supervisers: Dr Arun  Aniyan, Prof. Oleg Smirnov, Dr. Laura Richter.
 }\\
{\small Rhodes University \& SKA-SA, South Africa}%
% Don't put the department, it becomes too long.
}
\date{{\small 30 May 2018}\\%
  {\scriptsize\it Submitted in partial fulfillment of 
    a masters degree at Rhodes University}\\%
  \vspace{0.5cm}{\includegraphics[scale=0.3]{images/R.png}}}
%-------------------------------------------------------------------------
\begin{document}
